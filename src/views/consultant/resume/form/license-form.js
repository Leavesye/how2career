...
export default {
  ...
  certificateImage: {
    ...
    props: {
      ...
      "show-file-list": true,
      "auto-upload": true,
      "before-upload": function(index, file) {
        this.uploadBefore(file, index);
      },
      "on-success": function(index, res, file) {
        this.uploadSuccess(res, file, index, [
          "otherCertificates",
          "certificateImage"
        ]);
      },
      "on-remove": function(index, file, fileList) {
        this.uploadRemove(file, fileList, index, [
          "otherCertificates",
          "certificateImage"
        ]);
      }
